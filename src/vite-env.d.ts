...
/* Variables de entorno propias del proyecto.
   ...
   Van como `string | undefined` a propósito: no hay `.env` en el repo y el
   `Dockerfile` todavía no pasa las `VITE_*`, así que un build sin credenciales
   es un caso real y frecuente. Tiparlas como `string` a secas sería mentirle al
