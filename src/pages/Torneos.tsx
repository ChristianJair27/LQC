import { Trophy, Calendar, Users, Award, ChevronRight, Star, Clock, TrendingUp, Download, Share2 } from 'lucide-react'
...
const [activeStanding, setActiveStanding] = useState<string>("groups-standings");
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Fondo minimalista con líneas sutiles */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-b from-black via-gray-950 to-black"></div>
        <div className="absolute inset-0 opacity-5">
          <div className="h-full w-full bg-[linear-gradient(90deg,transparent_50%,rgba(255,255,255,0.05)_50%)] bg-[length:20px_20px]"></div>
        </div>
        <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-blue-900/30 to-transparent"></div>
        <div className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-transparent via-blue-900/30 to-transparent"></div>
      </div>
